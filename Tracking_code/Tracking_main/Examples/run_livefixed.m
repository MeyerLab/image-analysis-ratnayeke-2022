cd('F:\Data\D-Replication Initiation\D121-live\Processing')
%% Rename live sequence
% nikon_rename({'G:\D121_live\20210111_173919_522','G:\D121_live\20210111_195912_904','G:\C121-live-2nd\20210112_140050_182'},...
%      'G:\D121-live\Raw','COPY',false)
nikon_rename('L:\D121-IF\20210114_114925_056',...
     'L:\D121-IF\Raw','COPY',true)

%% Calculate Bias live
clear p
p.biaspath='G:\D121-live\Bias';  % Output path for bias
p.imagepath='G:\D121-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='D121-live';                % Experiment name
s.image_drive = 'G:\D121-live\';    % Location of images base folder
...
s.register_exception = [10:13];        % If don't register images, manually put in sites to register
...
%% Calculate Bias IF
clear p
p.biaspath='L:\D121-IF\Bias';  % Output path for bias
p.imagepath='L:\D121-IF\Raw';  % Image directory. If nikon, single folder for all sites
p.shadingpath=''; % cmos offset file for IX micro
p.names={
    'DAPI';
    'YFP';
...
% Timelapse_addIF( settings, 2,2,2, 0)
