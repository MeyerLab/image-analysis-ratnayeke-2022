function [tracedata,curdatatracked,tracking,nuc_label]=adaptivetrack_NR(tf,lastgoodframe,curframe,tracedata,curdata,tracking,nuc_raw,nuc_label,jitter,trackparams,debugpackage)
nucr=trackparams{1};
