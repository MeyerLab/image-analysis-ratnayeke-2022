...
% nikon_rename('K:\Nikon\C223-live\20191211_105924_735','K:\Nikon\C223-live\Raw','COPY',false)
% nikon_rename('K:\Nikon\C223-IF1\20191212_102359_475','K:\Nikon\C223-IF1\Raw','COPY',false)
% nikon_rename('K:\Nikon\C223-IF2\20191212_170221_080','K:\Nikon\C223-IF2\Raw','COPY',false)
%% Calculate Bias live
clear p
p.biaspath='K:\Nikon\C223-live\Bias';  % Output path for bias
p.imagepath='K:\Nikon\C223-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C223-live';
s.image_drive = 'K:\Nikon\C223-live\';
...
clear s
s.biaspath='K:\Nikon\C223-IF1\Bias';
s.imagepath='K:\Nikon\C223-IF1\Raw';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'DAPI';
...
% biasCalc(s,0);
  ...
  %% Prep processing
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C223-live\Data_old\';
settings.IF_imagesessions = {'G:\C223-IF1\', 'G:\C223-IF2\'};
settings.live_imagepath = 'G:\C223-live\Raw';
settings.bgcmospath = '';
settings.crop_save = 'G:\C223-IFcrop\';
settings.mask_save = 'G:\C223-IFcrop\';           % Output mask, leave empty if no save
