function liveFixedMulti_C130( row,col,site, debug_mode, logFolder, filePrefix)
% row=2;
% col=4;
% site=1;
% debug_mode = 1;
...
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C130-live\Data\';
settings.IF_imagesessions = {'D:\4TB4\Data\C130-IF\'};
settings.live_imagepath = 'D:\4TB4\Data\C130-live\Raw\';
