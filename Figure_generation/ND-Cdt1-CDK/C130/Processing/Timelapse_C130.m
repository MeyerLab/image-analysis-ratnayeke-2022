function Timelapse_C130(row,col,site,debug_mode)
% row = 2;
% col = 2;
% site = 3;
% debug_mode = 1;
...
%%% Paths
experiment_name='C130-live';
savepath=['F:\Data\C-Cdt1\',experiment_name,'\Data\'];
imagepath=['D:\4TB4\Data\',experiment_name,'\Raw\'];
biaspath=['D:\4TB4\Data\',experiment_name,'\Bias\'];
maskpath=['D:\4TB4\Data\',experiment_name,'\Mask\'];
