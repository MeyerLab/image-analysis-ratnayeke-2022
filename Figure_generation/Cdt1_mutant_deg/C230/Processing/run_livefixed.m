cd('F:\Data\C-Cdt1\C230-live2\Processing')
%% Rename live sequence
nikon_rename({'P:\C230-live2\20211125_112241_375',...
    'P:\C230-live2\20211125_112544_621',...
    'P:\C230-live2\20211125_122428_239',...
    'P:\C230-live2\20211125_123913_839'},...
     'P:\C230-live2\Raw','COPY',false)

%% Calculate Bias live
% clear p
% p.biaspath='N:\C230-live\Bias';  % Output path for bias
% p.imagepath='N:\C230-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C230-live2';                % Experiment name
s.image_drive = 'P:\C230-live2\';    % Location of images base folder
...
%%% General parameters
s.startFrame = 1;
s.endFrame = getMaxFrame(fullfile(s.imagepath,'2_5_1'),'Time(\d+)_');
...
s.register_exception = [1 2 3 19 20 21 23 24 25];        % If don't register images, manually put in sites to register
s.blocksize = 1000;
...
s.punctacalc = 2;                 % Analyze puncta in nucleus
s.punctaThresh = [200:200:1200];
s.varThresh = [300:100:800];
s.punctaFiltSize = 2;
