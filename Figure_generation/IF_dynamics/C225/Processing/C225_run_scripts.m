...
% IX_Micro_rename({'K:\Nalin\2020-0203-C225-live\2020-02-04\87', 'K:\Nalin\2020-0203-C225-live\2020-02-04\88'},...
%     'K:\C225-live\Raw',{'CFP','YFP','RFP'},'COPY',false)


%% Calculate Bias live
clear p
p.biaspath='K:\C225-live\Bias';  % Output path for bias
p.imagepath='K:\C225-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C225-live';
s.image_drive = 'K:\C225-live\';
...
IX_Micro_rename({'K:\Nalin\2020-0203-C225-IF1\2020-02-05\114\TimePoint_1'},'K:\C225-IF1\Raw',{'DAPI','YFP','FarRed'})
IX_Micro_rename({'K:\Nalin\2020-0203-C225-IF2\2020-02-06\117\TimePoint_1'},'K:\C225-IF2\Raw',{'DAPI','YFP','FarRed'})

%% Calculate Bias IF1 (using also for IF2)
clear s
s.biaspath='K:\C225-IF1\Bias';
s.imagepath='K:\C225-IF1\Raw';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'DAPI';
...
% biasCalc(s,0);
  ...
  %% Prep processing
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C225-live\Data\';
settings.IF_imagesessions = {'K:\C225-IF1\', 'K:\C225-IF2\'};
settings.live_imagepath = 'K:\C225-live\Raw';
settings.bgcmospath = 'C:\Users\Meyerlab\Documents\GitHub\cell-cycle-tracking\BGimages\IX_Liu\cmosoffset_bin1.mat';
settings.crop_save = 'K:\C225-IFcrop';
settings.mask_save = 'K:\C225-IFcrop';           % Output mask, leave empty if no save
...
settings.bgsubmethod = {{'global nuclear','none', 'none'},{'global nuclear', 'none', 'global nuclear'}}; %'global nuclear','global cyto','tophat','semi-local nuclear'
