...
setting.saveName = 'C225_data.mat';
setting.dataDir = 'F:\Data\C-Cdt1\Figures\Paper\GMNN_dynamics\C225';
        ...
        if setting.poiCrl
            ...
            if setting.poiG2
                [S(i).POI(:,5), badTracesCRL] = findCRLInact(S(i).crlNormAct, S(i).traceStats, S(i).POI(:,4), ...
                    ...
                    'buff',10,'thresh',.005,'preBuffer',5,'lowThresh',.2, 'increase',.05,'trunc',.5, 'medfilt',0,'early', 25,'debug',0));
            end
        end
