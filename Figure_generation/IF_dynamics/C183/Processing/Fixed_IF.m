...
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C183-live1frame\Data_fixed\';
settings.IF_imagesessions = {'I:\4TB8\Data\C183-IF1\','I:\4TB8\Data\C183-IF2\'};
settings.bgcmospath = 'F:\MATLAB\BGimages\IX_XL\cmosoffset_bin1.mat';
settings.maskpath = 'I:\4TB8\Data\C183-IFcrop\';
settings.crop_save = 'I:\4TB8\Data\C183-IFcrop\';
...
settings.postbin = 1;
settings.signals = {{'DAPI_','FarRed_'},{'DAPI_','CFP_','YFP_','FarRed_'}};
...
settings.ringcalc = {[1  1], [1 1 1 1]};
settings.ringthresh = {[0 0], [0 0 0 0]};
settings.punctacalc = {[0 0], [0 1 1 0]};
settings.punctaThresh = {{[],[]}, {[],[150 200 250],[150 200 250],[]}};
...
settings.bgsubmethod = {{'global nuclear', 'none'},...
    {'global nuclear', 'global nuclear', 'global nuclear', 'none'}}; %'global nuclear','global cyto','tophat','semi-local nuclear'
settings.bgperctile = {[50 50], [50 50 50 50]};
...
if any(cell2mat(settings.ringcalc))
    ...
    %{
        ...
        tempframe(:,:,1) = imadjust(mat2gray(real{1}{1}));
        tempframe(:,:,2) = extractmask;;
