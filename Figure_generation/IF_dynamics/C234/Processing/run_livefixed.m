cd('F:\Data\C-Cdt1\C234-live\Processing')
%% Rename live sequence
nikon_rename({'N:\C234-live\20211212_172051_007',...
    'N:\C234-live\20211212_220733_169'},...
     'N:\C234-live\Raw','COPY',false)

%% Calculate Bias live
clear p
p.biaspath='N:\C234-live\Bias';  % Output path for bias
p.imagepath='N:\C234-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C234-live';                % Experiment name
s.image_drive = 'N:\C234-live\';    % Location of images base folder
...
s.register_exception = [23 24 25 26];        % If don't register images, manually put in sites to register
s.blocksize = 5000;
...
nikon_rename({'N:\C234-live-fixed\20211214_162502_869'},...
     'N:\C234-live-fixed\Raw','COPY',false)
 
 %% Calculate Bias 
clear p
p.biaspath='N:\C234-live-fixed\Bias';  % Output path for bias
p.imagepath='N:\C234-live-fixed\Raw';  % Image directory. If nikon, single folder for all sites
p.shadingpath=''; % cmos offset file for IX micro
p.names={
    'DAPI';
    'YFP';
...
%% Setup add IF images
clear settings
settings.data_path = 'F:\Data\C-Cdt1\C234-live\Data\';      % Output location of mat files
settings.IF_imagesessions = {'N:\C234-live-fixed\'};    

settings.live_imagepath = 'N:\C234-live\Raw\';    % Live imaging raw image path
settings.bgcmospath = '';
settings.crop_save = 'N:\C234-live-fixed-crop';           % Output cropped images, leave empty if no save
settings.mask_save = 'N:\C234-live-fixed-crop';           % Output mask, leave empty if no save
...
settings.nucLive = 'FarRed_';       % Label for IX micro live nucleus (assume first tiff in stack for nikon)
settings.liveChannel = 3;         % If nikon use this tiff in stack for nuclear live
