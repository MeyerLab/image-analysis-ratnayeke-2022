...
%%% Conditions %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
settings.conditions = {
%   'GM Cdt1',2,2,1:9,[0 0 0],[]; %1    
        'GM Cdt1',2:3,2:3,1:9,[0 0 0],[]; %1    
        'Aphi Cdt1',4:5,2:3,1:9,[0 0 0],[]; %1  
        'Thy Cdt1',6:7,2:3,1:9,[0 0 0],[]; %1  
        
        'GM GMNN',2:3,4:5,1:9,[0 0 0],[]; %1    
        'Aphi GMNN',4:5,4:5,1:9,[0 0 0],[]; %1  
        'Thy GMNN',6:7,4:5,1:9,[0 0 0],[]; %1 
        
        'GM CCNA',2:3,6:7,1:9,[0 0 0],[]; %1    
        'Aphi CCNA',4:5,6:7,1:9,[0 0 0],[]; %1  
        'Thy CCNA',6:7,6:7,1:9,[0 0 0],[]; %1 
        
        'GM PCNA',2:3,8:9,1:9,[0 0 0],[]; %1    
        'Aphi PCNA',4:5,8:9,1:9,[0 0 0],[]; %1  
        'Thy PCNA',6:7,8:9,1:9,[0 0 0],[]; %1 
    };

%%% Paths %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
settings.dataDir = 'F:\Data\C-Cdt1\C237-live\Data';
...
settings.saveName = 'C237_data.mat';
settings.saveDir = 'F:\Data\C-Cdt1\C237-live\Plot';
%%% Analysis Options %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
