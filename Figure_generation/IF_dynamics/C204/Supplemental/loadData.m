...
setting.saveName = 'C204_data.mat';
setting.dataDir = 'F:\Data\C-Cdt1\Figures\Paper\GMNN_dynamics\C204';
...
for i = 1:uniqueCondnum
    ...
    if setting.IFoption
        ...
        S(i).FarRed1 = S(i).IFdata(:, find(ismember(IFnames,'1_FarRed_median')));
        S(i).YFP2 = S(i).IFdata(:, find(ismember(IFnames,'2_YFP_mean')));
        S(i).FarRed2 = S(i).IFdata(:, find(ismember(IFnames,'2_FarRed_median')));
...
%         S(i) = gateout_all(S(i),~(badTracesAPC));
    ...
    if setting.IFoption        
        ...
        S(i).allFarRed1 = allIFdata(:, find(ismember(IFnames,'1_FarRed_mean')));
                S(i).allFarRed2 = allIFdata(:, find(ismember(IFnames,'2_FarRed_mean')));
