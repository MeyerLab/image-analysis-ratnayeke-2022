...
nikon_rename({'K:\C226_live\20200314_162028_845', 'K:\C226_live\20200315_093225_986'},...
     'K:\C226-live\Raw','COPY',false)
nikon_rename({'K:\C226_FP1\20200315_112630_699'},'K:\C226-FP\Raw')
nikon_rename({'K:\C226_FP1\20200315_113350_801'},'K:\C226-FP\Raw')
nikon_rename({'K:\C226_FP1\20200316_113251_461'},'K:\C226-FP\Raw')
nikon_rename({'K:\C226_IF1\20200316_114531_397'},'K:\C226-IF1\Raw')
nikon_rename({'K:\C226_IF2\20200316_144017_708'},'K:\C226-IF2\Raw')

%% Calculate Bias live
clear p
p.biaspath='K:\C226-live\Bias';  % Output path for bias
p.imagepath='K:\C226-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C226-live';
s.image_drive = 'K:\C226-live\';
...
%% Calculate Bias FP (use YFP for IF2)
clear s
s.biaspath='K:\C226-FP\Bias';
s.imagepath='K:\C226-FP\Raw';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'CFP';
...
%% Calculate Bias IF1
clear s
s.biaspath='K:\C226-IF1\Bias';
s.imagepath='K:\C226-IF1\Raw';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'DAPI';
...
biasCalc(s,0);
  %% Prep processing
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C226-live\Data\';
settings.IF_imagesessions = {'K:\C226-IF1\', 'K:\C226-IF2\', 'K:\C226-FP\'};
settings.live_imagepath = 'K:\C226-live\Raw';
settings.bgcmospath = '';
settings.crop_save = 'K:\C226-IFcrop';
settings.mask_save = 'K:\C226-IFcrop';           % Output mask, leave empty if no save
...
settings.maxjit = 500;
settings.signals = {{'DAPI_','FarRed_'},{'DAPI_','YFP_'},{'CFP_','YFP_','RFP_'}};
...
settings.ringcalc = {[1 1 ], [0 1 ], [0 0 0]};
settings.ringthresh = {[0 0 ], [0 0], [0 0 0]};
settings.punctacalc = {[0 0], [0 0], [0 0 0]};
settings.punctaThresh = {{[],[],[]},{}};
settings.punctatopsize = 2;
settings.localbg = {[1 1], [1 1], [0 0 0]};
settings.minringsize = 100;
settings.bgcmoscorrection = 1; %1 = correct for shading; 0 = dont correct for shading;
settings.bgsubmethod = {{'global nuclear','none'},{'global nuclear', 'none'},{'global nuclear', 'global nuclear','global nuclear'}}; %'global nuclear','global cyto','tophat','semi-local nuclear'
...
settings.areahighthresh = 1;

Timelapse_addIF(settings,7,4,3,0)
...
%% Run Fixed
settings.IF_imagesessions = {'K:\C226-IF1\', 'K:\C226-FP\'};
settings.crop_save = 'K:\C226-IFcrop';
settings.mask_save = 'K:\C226-IFcrop';   
...
settings.bleedthroughslope = {};
settings.bleedthroughoff = {};
settings.ringcalc = {[1 1 ], [0 0 0]};
settings.ringthresh = {[0 0 ], [0 0 0]};
settings.punctacalc = {[0 0], [0 0 0]};
settings.punctaThresh = {{[],[],[]},{}};
settings.punctatopsize = 2;
settings.localbg = {[1 1], [0 0 0]};
settings.minringsize = 100;
settings.bgcmoscorrection = 1; %1 = correct for shading; 0 = dont correct for shading;
settings.bgsubmethod = {{'global nuclear','none'},{'global nuclear', 'global nuclear','global nuclear'}}; %'global nuclear','global cyto','tophat','semi-local nuclear'
