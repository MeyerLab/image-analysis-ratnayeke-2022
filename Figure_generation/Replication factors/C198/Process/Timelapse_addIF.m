...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% %%% Paths
% settings.data_path = 'F:\Data\C-Cdt1\C192-live\Data\';
% settings.IF_imagesessions = {'E:\4TB11\Data\C192-IF1\', 'E:\4TB11\Data\C192-IF2\'};
% settings.live_imagepath = 'E:\4TB11\Data\C192-live\Raw\';
% settings.bgcmospath = 'F:\MATLAB\BGimages\IX_Liu\cmosoffset_bin1.mat';
% settings.crop_save = 'E:\4TB11\Data\C192-IFcrop\';
