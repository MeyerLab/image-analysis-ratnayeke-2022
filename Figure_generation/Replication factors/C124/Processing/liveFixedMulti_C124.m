function liveFixedMulti_C124( row,col,site, debug_mode, logFolder, filePrefix)
% row=2;
% col=2;
% site=1;
% debug_mode = 1;
...
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C124-live\Data\';
settings.IF_imagesessions = {'I:\4TB1\Data\C124-IF\'};
settings.live_imagepath = 'I:\4TB1\Data\C124-live\Raw\';
...
%%% Tracking parameters
settings.distthresh = 1*settings.nucr;
