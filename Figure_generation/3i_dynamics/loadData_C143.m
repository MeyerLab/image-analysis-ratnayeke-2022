function [S] = loadData_C143(conditions, dataDir)
...
setting.saveName = 'C143_data.mat';
    ...
    if ~isempty(setting.sig)
        ...
        if setting.poiCrl
           S(i).POI(:,3) = findCRL4Act(S(i).sigNorm,S(i).traceStats, ...
                ...
                'firstD',0.01,'secD',-.001,'early', 5,'falseCall', .9,'buff',0, 'postBuffer', 6,'decrease', .02*6,'debug',0));
