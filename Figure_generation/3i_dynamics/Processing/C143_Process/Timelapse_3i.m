...
%%% Paths
s.experiment_name='C143-3i-live';
s.savepath=['F:\Data\C-Cdt1\',s.experiment_name,'\Data\'];
s.imagepath=['F:\Data\3i Data\PCNA 45\C143-PCNA3i\Raw\'];
s.maskpath=['F:\Data\3i Data\PCNA 45\C143-PCNA3i\Mask\'];

%%% General parameters
s.startFrame=1;   %Frame to start analyzing from
s.endFrame=91;  %Frame to stop analyzing
...
punctaSemiBlur = imgaussfilt(punctaSig, .5);
...
punctaFilt = imtophat(punctaSig, strel('disk',3,0));
