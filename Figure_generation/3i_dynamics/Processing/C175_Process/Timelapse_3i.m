...
%%% Paths
s.experiment_name='C175-3i-live';
s.savepath=['F:\Data\C-Cdt1\',s.experiment_name,'\Data\'];
s.imagepath=['F:\Data\3i Data\PCNA 45\C175-3i-ind\Raw\'];
s.maskpath=['F:\Data\3i Data\PCNA 45\C175-3i-ind\Mask\'];
