...
settings.IF_imagesessions = {'H:\4TB7\Data\C156-IF1\', 'H:\4TB7\Data\C156-IF2\'};
settings.live_imagepath = 'H:\4TB7\Data\C156-live\Raw\';
...
settings.bgsubmethod = {{'global nuclear','tophat', 'tophat'}, ...
     {'global nuclear','tophat', 'tophat'}}; %'global nuclear','global cyto','tophat','semi-local nuclear'
...
regheight = 1:settings.jitterScale*height;
regwidth = 1:settings.jitterScale*width;
jitmatx = [];
jitmaty = [];
...
if any(cell2mat(settings.ringcalc))
    if (settings.magnification == 10 & settings.binsize == 1) | ...
        ...
        innerrad = 2; outerrad = 15; % 10 by default from Min
    end
