function Timelapse_C156(row,col,site,debug_mode)
% row = 2;
% col = 2;
% site = 1;
% debug_mode = 0;
...
%%% Paths
experiment_name='C156-live';
image_drive = 'G:\4TB7\Data\';
...
endFrame=84;  %Frame to stop analyzing
...
secondsegmethod = 'log'; %Options: 'concavity', 'log', 'single adapt', 'double adapt', 'single', 'double'
nucr = 12; %10x bin1 = 12 and 20x bin2 = 12
blurradius  =  3; %10x: 3
soliditythresh = 0.8;
debrisarea = 150; % 10x = 100 % 150 if no mitosis
...
switch segMethod
    ...
    case 'log'
        mask = blobdetector_5(log(image),s.nucr,s.blobthreshold);
    case 'single adapt'
