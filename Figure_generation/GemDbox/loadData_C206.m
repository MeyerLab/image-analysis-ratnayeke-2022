function [S] = loadData_C206(conditions, dataDir)
...
setting.saveName = 'C206_data.mat';
setting.dataDir = 'F:\Data\C-Cdt1\Figures\Paper\CActerm';
        ...
        if setting.poiApc
            if setting.quiescent
                [S(i).POI(:,2), badTracesAPC] = findAPCInact(S(i).apcNuc, S(i).traceStats, ...
                    ...
                    'buff',1,'thresh',.4,'preBuffer',1,'lowThresh',20, 'increase',10*.4,'trunc',50, 'medfilt',0,'early', 25));
            else
