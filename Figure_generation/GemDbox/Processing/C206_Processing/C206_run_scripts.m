%% Rename live sequence
  %nikon_rename_time('I:\Nikon\C206-live\Raw2','I:\Nikon\C206-live\Raw','COPY',false)

%% Calculate Bias live
clear p
p.biaspath='I:\Nikon\C206-live\Bias';  % Output path for bias
p.imagepath='I:\Nikon\C206-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C206-live';
s.image_drive = 'I:\Nikon\C206-live\';
...
%% Calculate Bias IF1
clear s
s.biaspath='I:\Nikon\C206-IF1\Bias';
s.imagepath='I:\Nikon\C206-IF1\RawBias';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'DAPI';
...
% biasCalc(s,0);
  ...
  %% Prep processing
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C206-live\Data\';
settings.IF_imagesessions = {'I:\Nikon\C206-IF1\', 'I:\Nikon\C206-IF2\'};
settings.live_imagepath = 'I:\Nikon\C206-live\Raw\';
settings.bgcmospath = '';
settings.crop_save = 'I:\Nikon\C206-IFcrop\';
settings.mask_save = 'I:\Nikon\C206-IFcrop\';           % Output mask, leave empty if no save
...
settings.punctacalc = {[0 0 1], [0 0 ]};
settings.punctaThresh = {{[],[],[100:50:300]},{}};
settings.punctatopsize = 2;
settings.localbg = {[1 1 1], [0 0 
   ]};
...
% Timelapse_addIF(settings,4,7,5,0)
