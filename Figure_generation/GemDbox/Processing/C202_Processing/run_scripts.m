...
% nikon_rename_time('I:\Nikon\C202-live\Raw2','I:\Nikon\C202-live\Raw1','COPY',false)

%% Calculate Bias live
% clear p
% p.biaspath='I:\Nikon\C202-live\Bias';  % Output path for bias
% p.imagepath='I:\Nikon\C202-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
% s.experiment_name='C202-live';
% s.image_drive = 'I:\Nikon\C202-live\';
...
%% Calculate Bias IF1
clear s
s.biaspath='I:\Nikon\C202-IF1\Bias';
s.imagepath='I:\Nikon\C202-IF1\Raw';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'DAPI';
...
%  biasCalc(s,0);
  ...
  %% Prep processing
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C202-live\Data\';
settings.IF_imagesessions = {'I:\Nikon\C202-IF1\', 'I:\Nikon\C202-IF2\'};
settings.live_imagepath = 'I:\Nikon\C202-live\Raw\';
settings.bgcmospath = '';
settings.crop_save = 'I:\Nikon\C202-IFcrop\';
settings.mask_save = 'I:\Nikon\C202-IFcrop\';           % Output mask, leave empty if no save
