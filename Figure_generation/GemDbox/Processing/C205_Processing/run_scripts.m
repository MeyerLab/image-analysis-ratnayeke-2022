...
%  nikon_rename_time('H:\Nikon\C205-live\Raw2','H:\Nikon\C205-live\Raw','COPY',false)

%% Calculate Bias live
% clear p
% p.biaspath='H:\Nikon\C205-live\Bias';  % Output path for bias
% p.imagepath='H:\Nikon\C205-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C205-live';
s.image_drive = 'H:\Nikon\C205-live\';
...
%% Calculate Bias IF1
clear s
s.biaspath='H:\Nikon\C205-IF1\Bias';
s.imagepath='H:\Nikon\C205-IF1\RawBias';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'DAPI';
...
s.sigma = 25; % pixel
 ...
 %biasCalc(s,0);
  ...
  %% Prep processing
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C205-live\Data\';
settings.IF_imagesessions = {'H:\Nikon\C205-IF1\', 'H:\Nikon\C205-IF2\'};
settings.live_imagepath = 'H:\Nikon\C205-live\Raw\';
settings.bgcmospath = '';
settings.crop_save = 'H:\Nikon\C205-IFcrop\';
settings.mask_save = 'H:\Nikon\C205-IFcrop\';           % Output mask, leave empty if no save
