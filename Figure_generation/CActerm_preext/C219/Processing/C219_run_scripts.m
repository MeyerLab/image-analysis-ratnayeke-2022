...
% nikon_rename_time('K:\Nikon\C219-live\Raw2','K:\Nikon\C219-live\Raw','COPY',false)

%% Calculate Bias live
clear p
p.biaspath='K:\Nikon\C219-live\Bias';  % Output path for bias
p.imagepath='K:\Nikon\C219-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C219-live';
s.image_drive = 'K:\Nikon\C219-live\';
...
clear s
s.biaspath='I:\Nikon\C219-IF2\Bias';
s.imagepath='I:\Nikon\C219-IF2\Raw';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'DAPI';
...
settings.IF_imagesessions = {'J:\C219-IF2\'};
settings.live_imagepath = 'J:\C219-live\Raw\';
settings.bgcmospath = '';
settings.crop_save = '';
settings.mask_save = 'J:\C219-IF2\Mask\';           % Output mask, leave empty if no save
