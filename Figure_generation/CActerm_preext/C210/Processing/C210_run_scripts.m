...
%% Calculate Bias live
clear p
p.biaspath='I:\Nikon\C210-live\Bias';  % Output path for bias
p.imagepath='I:\Nikon\C210-live\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Paths
s.experiment_name='C210-live';
s.image_drive = 'I:\Nikon\C210-live\';
...
%% Calculate Bias IF1
clear s
s.biaspath='I:\Nikon\C210-IF1\Bias';
s.imagepath='I:\Nikon\C210-IF1\Raw';
s.shadingpath='';
s.nucradius=24;%12;
s.names={
    'DAPI';
...
s.sigma = 25; % pixel
 ...
 %biasCalc(s,0);
  ...
  %% Prep processing
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C210-live\Data\';
settings.IF_imagesessions = {'I:\Nikon\C210-IF1\'};
settings.live_imagepath = 'I:\Nikon\C210-live\Raw\';
settings.bgcmospath = '';
settings.crop_save = '';
settings.mask_save = 'I:\Nikon\C206-IF1\';           % Output mask, leave empty if no save
