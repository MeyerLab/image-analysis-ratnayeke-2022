...
for i = 1:uniquecondnum
    ...
    S(i).DAPI1 = IFdata(:, find(ismember(IFnames,'1_DAPI__mean')));
    S(i).FITC1 = IFdata(:, find(ismember(IFnames,'1_FITC__mean')));
    S(i).FarRed1 = IFdata(:, find(ismember(IFnames,'1_FarRed__mean')));
    
   S(i).FITC2 = IFdata(:, find(ismember(IFnames,'2_FITC__mean')));
    S(i).mCherry2 = IFdata(:, find(ismember(IFnames,'2_mCherry__mean')));
