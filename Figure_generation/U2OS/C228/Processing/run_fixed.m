cd('F:\Data\C-Cdt1\C228-fixed')
%% Rename IF 
nikon_rename('K:\C228-IF\20211007_124918_258',...
     'K:\C228-IF\Raw','COPY',false,'SINGLE_SITE',false)


%% Calculate Bias IF
clear p
p.biaspath='K:\C228-IF\Bias';  % Output path for bias
p.imagepath='K:\C228-IF\Raw';  % Image directory. If nikon, single folder for all sites
...
%% Setup IF images
clear settings
settings.data_path = 'F:\Data\C-Cdt1\C228-fixed\Data\';      % Output location of mat files
settings.IF_imagesessions = {'K:\C228-IF\'};    
...
settings.localbg = { [0  0 0 0]};        % Measure local background in box around cell
