...
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C184-live-nikon\Data\';
settings.IF_imagesessions = {'I:\C184-IF1-nikon\'};
settings.live_imagepath = 'I:\C184-live-nikon\Raw_rename\';
settings.bgcmospath = '';
settings.crop_save = 'I:\C184-IF1-nikon\mask\';
