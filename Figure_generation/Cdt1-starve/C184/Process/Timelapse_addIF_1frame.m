function Timelapse_addIF_1frame( row,col,site, debug_mode, logFolder, filePrefix)
row = 7;
col = 2;
site = 2;
debug_mode = 1;
...
%%% Paths
settings.data_path = 'F:\Data\C-Cdt1\C184-live-nikon\Data_1frame\';
settings.IF_imagesessions = {'G:\4TB9\Data\C184-IF1-nikon\'};
settings.live_imagepath = 'G:\4TB9\Data\C184-live-nikon\Raw_rename\';
settings.bgcmospath = '';
settings.crop_save = '';
...
settings.punctaThresh = {{[],[200 250 300],[ 100 150 200]}};
...
%     try
        ...
        live.rawprev=single(imread([rawLiveDir,settings.nucLive,num2str(108),'.tif']));
...
%%% overlay nuclear images %%%%%%%%%%%%%%%%%
rawresize = imresize(live.rawprev,size(real_padded{1}{1}));
[rawprevcrop,raw1crop]=cropboth(rawresize,real_padded{1}{1},reljitx,reljity);
...
if numsites==4 & strcmp(microscope,'IX micro')
    switch site
        case 1
            upperleft=1;
            upperright=2;
