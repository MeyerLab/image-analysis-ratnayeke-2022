...
%%% Paths
s.experiment_name='C184-live-nikon';
s.image_drive = 'E:\4TB9\Data\';
s.savepath=['F:\Data\C-Cdt1\',s.experiment_name,'\Data\'];
s.imagepath=[s.image_drive,s.experiment_name,'\Raw_rename\'];
...
s.endFrame=108;  %Frame to stop analyzing
