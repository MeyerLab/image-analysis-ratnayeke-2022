...
setting.saveName = 'C184_data.mat';
setting.dataDir = 'F:\Data\C-Cdt1\Figures\Paper\cdt1_starve';
...
for i = 1:uniqueCondnum
    ...
    if setting.IFoption
        ...
        S(i).DAPI = S(i).IFdata(:, find(ismember(IFnames,'1_DAPI__mean')));
        S(i).YFP = S(i).IFdata(:, find(ismember(IFnames,'1_YFP__mean')));        
        S(i).FarRed = S(i).IFdata(:, find(ismember(IFnames,'1_FarRed__mean')));
